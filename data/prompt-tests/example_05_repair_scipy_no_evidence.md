# Repair Prompt Test — scipy without PyPI evidence
...
```json
{
  ...
  "version": null,
  "command": null,
  "rationale": "No safe pip-only fix can be proposed without PyPI version data.",
  "pypi_evidence": {
    "latest_version": null,
    "chosen_version": null,
...
* Valid JSON: pass
* Allowed action: pass
* Correctly abstains without PyPI version evidence: pass
